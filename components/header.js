...
const Header = (props) => {
  ...
  return (
    <header className="fixed left-0 top-0 md:ml-64 w-full md:w-[calc(100%-256px)] bg-[#143d59]/90 flex items-center justify-between p-4 z-40">
      <div>
        <RiMore2Fill
      ...
      <div className="flex items-center gap-6">
        ...
        <Link
          href="/"
          className="py-2 md:py-3 px-4 rounded-full text-black bg-white font-medium hover:scale-105 transition-transform"
        >
          Sign In
        </Link>
      </div>
