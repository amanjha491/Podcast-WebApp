...
const FirstCard = () => {
  return (
    ...
    >
      ...
      <div>
        <h5 className="font-medium text-black mb-2">Today&#39;s Top Hits</h5>
        <p className="text-black text-sm w-[18ch]">
...
const SecondCard = () => {
  return (
    ...
    >
      ...
      <div>
        <h5 className="font-medium text-black mb-2">RapCaviar</h5>
        <p className="text-black text-sm w-[18ch]">
...
const ThirdCard = () => {
  return (
    ...
    >
      ...
      <div>
        <h5 className="font-medium text-black mb-2">All Out 2010s</h5>
        <p className="text-black text-sm w-[18ch]">
...
const FourthCard = () => {
  return (
    ...
    >
      ...
      <div>
        <h5 className="font-medium text-black mb-2">Rock Classics</h5>
        <p className="text-black text-sm w-[18ch]">
...
const FifthCard = () => {
  return (
    ...
    >
      ...
      <div>
        <h5 className="font-medium text-black mb-2">Sleep</h5>
        <p className="text-black text-sm w-[18ch]">
...
const SixthCard = () => {
  return (
    ...
    >
      ...
      <div>
        <h5 className="font-medium text-black mb-2">DayDreamer</h5>
        <p className="text-black text-sm w-[18ch]">
...
const SeventhCard = () => {
  return (
    ...
    >
      ...
      <div>
        <h5 className="font-medium text-black mb-2">Peaceful Piano</h5>
        <p className="text-black text-sm w-[18ch]">
...
const EighthCard = () => {
  return (
    ...
    >
      ...
      <div>
        <h5 className="font-medium text-black mb-2">Deep Focus</h5>
        <p className="text-black text-sm w-[18ch]">
...
const NinthCard = () => {
  return (
    ...
    >
      ...
      <div>
        <h5 className="font-medium text-black mb-2">Instrumental Study</h5>
        <p className="text-black text-sm w-[18ch]">
...
const EleventhCard = () => {
  return (
    ...
    >
      ...
      <div>
        <h5 className="font-medium text-black mb-2">Mood Booster</h5>
        <p className="text-black text-sm w-[18ch]">
...
const TwelfthCard = () => {
  return (
    ...
    >
      ...
      <div>
        <h5 className="font-medium text-black mb-2">Feelin&#39; Good</h5>
        <p className="text-black text-sm w-[18ch]">
...
const ThirteenthCard = () => {
  return (
    ...
    >
      ...
      <div>
        <h5 className="font-medium text-black mb-2">Dark & Stormy</h5>
        <p className="text-black text-sm w-[18ch]">
...
const FourteenthCard = () => {
  return (
    ...
    >
      ...
      <div>
        <h5 className="font-medium text-black mb-2">Feel Good Piano</h5>
        <p className="text-black text-sm w-[18ch]">
...
const FifteenthCard = () => {
  return (
    ...
    >
      ...
      <div>
        <h5 className="font-medium text-black mb-2">Start Nowhere</h5>
        <p className="text-black text-sm w-[18ch]">Sam Hunt</p>
      </div>
    </Link>
  );
};
...
const SixteenthCard = () => {
  return (
    ...
    >
      ...
      <div>
        <h5 className="font-medium text-black mb-2">This Is What I Mean</h5>
        <p className="text-black text-sm w-[18ch]">Stormzy</p>
      </div>
    </Link>
  );
};
...
const SeventeenthCard = () => {
  return (
    ...
    >
      ...
      <div>
        <h5 className="font-medium text-black mb-2">Love Sux (Deluxe)</h5>
        <p className="text-black text-sm w-[18ch]">Avril Lavigne</p>
      </div>
    </Link>
  );
};
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="text-black text-sm w-[18ch]">Jung Kook, BTS</p>
      </div>
    </Link>
  );
};
